...
const Header: React.FC<IHeaderProps> = ({ isDesktop }) => {
    ...
    return (
        <header className="p-6  justify-between fixed top-0 z-50 bg-white w-full md:flex">
            {/*<header className="fixed top-0 left-0 w-full bg-white shadow-md z-50 px-6 py-4 flex justify-between  md:flex">*/}
            ...
            <div className={`mr-8 md:space-x-6 md:block mt-3 md:mt-0 ${isDesktop || navItem ? 'block' : 'hidden'}`}>
